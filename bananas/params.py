...
def algo_params(param_str):
    ...
    if param_str == 'main_experiments':
        params.append({'algo_name':'random', 'total_queries':1000})
        params.append({'algo_name':'evolution', 'total_queries':1000})
        params.append({'algo_name':'gp_bayesopt', 'total_queries':1000})        
